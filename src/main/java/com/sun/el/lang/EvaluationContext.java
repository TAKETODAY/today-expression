...
/**
 * The context for EL expression evaluation. This wrapper ELContext captures the
 * function mapper and the variable mapper at the point when the epxression is
 * parsed, and only for those functions and variable used in the expression.
 */
