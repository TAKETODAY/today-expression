 ...
 *
 * <p>
 * For example, this could be triggered by an index out of bounds while setting
 * an array value, or by an unreadable property while getting the value of a
 * JavaBeans property.
 * </p>
 *
 * @since JSP 2.1
...
public class PropertyNotFoundException extends ELException {
	...
	// -------------------------------------
	/**
	 * Creates a <code>PropertyNotFoundException</code> with the provided detail
	 * message.
	 *
	 * @param message
	 *            the detail message
