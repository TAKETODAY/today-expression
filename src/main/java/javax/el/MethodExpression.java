 ...
 *
 * <p>
 * The {@link javax.el.ExpressionFactory#createMethodExpression} method can be
 * used to parse an expression string and return a concrete instance of
 ...
 * For any of the two methods, the {@link javax.el.ELResolver#getValue} method
 ...
 * must be thrown. At the last resolution, the final <code>property</code> is
 * then coerced to a <code>String</code>, which provides the name of the method
 * to be found. A method matching the name and expected parameters provided at
 * parse time is found and it is either queried or invoked (depending on the
 * method called on this <code>MethodExpression</code>).
 * </p>
 *
 * <p>
...
public abstract class MethodExpression extends Expression {
	 ...
	 * <code>ELException</code> is thrown if <code>expectedReturnType</code> is void
	 * or if the coercion of the String literal to the
	 * <code>expectedReturnType</code> yields an error (see Section "1.18 Type
	 * Conversion" of the EL specification).
	 * 
	 * If not a String literal, evaluates the expression relative to the provided
	 * context, invokes the method that was found using the supplied parameters, and
