 ...
 *
 * <p>
 * A <code>FunctionMapper</code> maps <code>${prefix:name()}</code> style
 * functions to a static method that can execute that function.
 * </p>
 *
 * @since JSP 2.1
 */
public abstract class FunctionMapper {
	 ...
	 *
	 * <p>
	 * Returns <code>null</code> if no function could be found that matches the
